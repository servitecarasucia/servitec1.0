...
Friend MustInherit Class clsConexionBD
    ...
    Sub New()
        ...
        cadena = "database=servitecwebd; data source=localhost; user id=root;password=root"
        'cadena = "database=servitecwebd; data source=192.168.1.10; user id=root;password=admin"
