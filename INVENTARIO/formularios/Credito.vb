...
Public Class Ventas
    ...
    Private Sub insertardetalle()
        Try
            ...
            tdetalleventa.Insertar(CInt(Me.codfactura).ToString & ",'" & idproducto & "'," & Math.Round(CDbl(Me.texcantidad.Text), 2).ToString & ",0," & prereal & ",0," & Math.Round(ventatotal, 2) & ", 0 ," & Math.Round(CDbl(Me.texprecio.Text), 2))
            ' privar()
        ...
        Try
            If checklibre.Checked <> True Then
                ...
                Else
                    ...
                    Me.preciot = FormatNumber(CDec(Me.texprecio.Text), 2)
    ...
    Private Sub imprimirfactura()
        ...
        Dim TamañoPersonal As New Printing.PaperSize("Prueba", 550, 800)
    ...
    Private Sub botguardar_Click(sender As Object, e As EventArgs) Handles botguardar.Click
        Try
            If Me.textotal.Text.ToString.Trim <> "0" And Me.textotal.Text.ToString.Trim <> "0.0" Then
                ...
                dtc = consultar.Consultar("SELECT cliente FROM clientescf where idclientescf = " & idcliente)
                Dim ella As String = ""
                ...
                If MsgBox("Cliente: " & dtc.Rows(0).Item(0).ToString & vbCrLf _
    ...
    Private Sub guardardocumento()
        Try
            ...
            Else
                ...
                If Not yasellenoelcliente Then
                    idclienteestablecer()
                End If

                If combotipo.Text.ToString <> "Factura" Or combotipo.Text.ToString <> "Comprobante de credito fiscal" Then
                    tipo = "Factura"
                End If
                consultar.Consultar(" update facturaventa set numfacturav = '" & Me.texnumfact.Text.ToString.Trim & "', tipo = '" & tipo & "', codcliente = '" & idcliente & "', fecha = '" & f & "', formadepago = '" & Me.comboformapago.Text.ToString & "', tiraje = '" & Me.textiraje.Text.ToString & "', " & " sumas = " & Me.texsumas.Text.Trim.ToString & ", iva = " & Me.texiva.Text.Trim.ToString & ", total = " & Me.textotal.Text.Trim.ToString & " where codfacturav = " & codfactura)
    ...
    Private Sub texcliente_KeyDown(sender As Object, e As KeyEventArgs) Handles texcliente.KeyDown
        Try
            ...
            If e.KeyCode = 40 Then
                Me.gridclientes.Focus()
                Me.gridclientes.CurrentRow.Cells(1).Selected = True
            End If
        Catch ex As Exception
    ...
    Private Sub cargarcli()
        yasellenoelcliente = True
        Try

            If Me.gridclientes.Visible Then
    ...
    Private Sub gridproductos_KeyDown(sender As Object, e As KeyEventArgs) Handles gridproductos.KeyDown
        If e.KeyCode = 13 Then
            ...
            Me.texprecio.Text = dtrproducto1.Item(5)
            Me.texcantidad.Focus()
    ...
    Private Sub texcantidad_KeyDown(sender As Object, e As KeyEventArgs) Handles texcantidad.KeyDown, texprecio.KeyDown, textotalp.KeyDown
