...
) ENGINE=MyISAM AUTO_INCREMENT=3054 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalleventa` (
  ...
  KEY `codproducto` (`codproducto`)
) ENGINE=MyISAM AUTO_INCREMENT=8766 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturacompra` VALUES (606,0,'Factura',58,'2016-07-05',216.52,0,0,0,0,216.52,'Contado',0,'valida','0','2016-07-05'),(607,0,'Comprobante de Credito fiscal',58,'2016-07-06',482.12,0,62.68,0,0,544.8,'Contado',0,'valida','0','2016-07-06');
...
) ENGINE=MyISAM AUTO_INCREMENT=3205 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tirajes` VALUES (1,'16AN000F','1','150','116',' 16AN000C','1','50','1');
...
-- Dump completed on 2016-07-06 14:55:26
