...
CREATE TABLE `detalleventa` (
  ...
  KEY `codproducto` (`codproducto`)
) ENGINE=MyISAM AUTO_INCREMENT=8772 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturacompra` VALUES (606,0,'Factura',58,'2016-07-05',216.52,0,0,0,0,216.52,'Contado',0,'valida','0','2016-07-05'),(607,0,'Comprobante de Credito fiscal',58,'2016-07-06',482.12,0,62.68,0,0,544.8,'Contado',0,'valida','0','2016-07-06'),(608,0,'Comprobante de Credito fiscal',58,'2016-07-06',382.48,0,49.72,0,0,432.2,'Contado',0,'valida','00','2016-07-07'),(609,0,'Comprobante de Credito fiscal',58,'2016-07-06',2119.17,0,275.49,0,0,2394.66,'Contado',0,'valida','000','2016-07-07');
...
) ENGINE=MyISAM AUTO_INCREMENT=3206 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tirajes` VALUES (1,'16AN000F','1','150','116',' 16AN000C','1','50','40');
...
-- Dump completed on 2016-07-07 16:24:03
