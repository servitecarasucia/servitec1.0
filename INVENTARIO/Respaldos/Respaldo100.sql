...
CREATE TABLE `detalleventa` (
  ...
  KEY `codproducto` (`codproducto`)
) ENGINE=MyISAM AUTO_INCREMENT=8857 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=3241 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notificaciones` VALUES (13,1,'Comprobante de Credito fiscal','Gustavo Antonio Gutierrez Valiente',25.99,3239),(14,2,'Factura','Consumidor Final',5.3,3240);
...
-- Dump completed on 2016-07-25 15:22:08
